...
public class ParametersUI {
  ...
  public void addBinder(String group, ParameterBinder creator) {
  ...
  /**
   * Creates a JPanel that will display the specified parameters. This assumes
   * the passed in parameters are identical to those used to make the creators
   * that were added with addBinder.
   * 
   * @param params
   * 
   ...
   * @throws FileNotFoundException
   */
  public JPanel createPanel(String parametersFile) throws FileNotFoundException,
      XMLStreamException {
   ...
   * Creates a JPanel that will display the specified parameters. This assumes
   * the passed in parameters are identical to those used to make the creators
   * that were added with addCreator.
   * 
   * @param params
   * 
   * @return the created JPanel.
   ...
   * @throws FileNotFoundException
   */
  public JPanel createPanel(File parametersFile) throws FileNotFoundException,
      XMLStreamException {
...
//    }
  ...
  private JPanel createPanel(Parameters params, List<ParameterBinder> binders) {
    ...
    for (ParameterBinder creator : binders) {
  ...
  /**
   * Gets the parameter xml representation of the currently created parameter
   * UI. The current values in the UI will become the default values.
   * 
   * @return the XML.
   */
  public String toXML() {
