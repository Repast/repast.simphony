...
public class ParametersUIParser {
        ...
        private void processParameter(StartElement elmt, ParametersUI creator) {
                ...
                boolean readOnly = elmt.getAttributeByName(IS_READ_ONLY_A) == null ? false : Boolean.parseBoolean(elmt.getAttributeByName(IS_READ_ONLY_A)
                                .getValue());

                boolean hide = elmt.getAttributeByName(HIDE_A) == null ? false : Boolean.parseBoolean(elmt.getAttributeByName(HIDE_A).getValue());
