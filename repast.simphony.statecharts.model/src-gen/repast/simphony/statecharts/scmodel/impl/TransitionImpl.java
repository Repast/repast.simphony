...
public class TransitionImpl extends EObjectImpl implements Transition {
   ...
   * <em>Message Checker Condition Language</em>}' attribute. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
  ...
  /**
   * The cached value of the '{@link #getMessageCheckerConditionLanguage()
   * <em>Message Checker Condition Language</em>}' attribute. <!--
   * begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getMessageCheckerConditionLanguage()
   ...
   * @ordered
   */
  protected boolean selfTransition = SELF_TRANSITION_EDEFAULT;
  ...
  public void setFrom(AbstractState newFrom) {
    ...
    from = newFrom;
    setOutOfBranch(from instanceof PseudoState
        && ((PseudoState) from).getType().equals(PseudoStateTypes.CHOICE));

    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StatechartPackage.TRANSITION__FROM,
          oldFrom, from));
  }
  ...
  public void setTo(AbstractState newTo) {
    ...
    to = newTo;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StatechartPackage.TRANSITION__TO,
          oldTo, to));
  }
