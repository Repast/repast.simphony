...
public class StatechartSwitch<T> extends Switch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case StatechartPackage.STATE_MACHINE: {
      ...
      case StatechartPackage.COMPOSITE_STATE: {
      ...
      case StatechartPackage.HISTORY: {
        History history = (History)theEObject;
        T result = caseHistory(history);
        if (result == null) result = caseState(history);
        if (result == null) result = caseAbstractState(history);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
