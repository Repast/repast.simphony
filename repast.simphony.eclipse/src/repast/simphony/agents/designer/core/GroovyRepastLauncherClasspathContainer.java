...
public class GroovyRepastLauncherClasspathContainer extends GroovyClasspathContainer {
  ...
  public IClasspathEntry[] getClasspathEntries() {
    ...
    if (classpathList == null) {
      ...
      String[] jarPathList = AgentBuilderPlugin.getJarPathListForLauncher();
      ...
      for (int i = groovyEntriesLength; i < totalListLength; i++) {
        ...
        if ((jarPath.getFileExtension() != null)
          ...
          // dev class path removes ECLIPSE_HOME but leaves workspace_loc
          // to be added as a variable. Everything else is a straight bin folder.
          if (AgentBuilderPlugin.isRunningInDevEnv()) {
