...
public class GroovyRepastLauncherClasspathContainer extends GroovyClasspathContainer {
  ...
  private static final String DESCRIPTION = RepastSimphonyPlugin.getInstance().getResourceString("Classpath_Container_Launcher.description");
  ...
  public IClasspathEntry[] getClasspathEntries() {
    ...
    if (classpathList == null) {
      ...
      String[] jarPathList = RepastSimphonyPlugin.getInstance().getClassPathListForLauncher();
      ...
      for (int i = groovyEntriesLength; i < totalListLength; i++) {
        ...
        if ((jarPath.getFileExtension() != null)
          ...
          // if running in the ECLIPSE_HOME is removed but workspace_loc remains in classpath
          // and it needs to be added as a variable. Everything else is not a jar handled by above,
