...
/**
 * This is the item provider adapter for a {@link repast.simphony.statecharts.scmodel.PseudoState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PseudoStateItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_PseudoState_type_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_PseudoState_type_feature", "_UI_PseudoState_type"),
         StatechartPackage.Literals.PSEUDO_STATE__TYPE,
         true,
         false,
         false,
  ...
  public String getText(Object object) {
    String label = ((PseudoState)object).getId();
