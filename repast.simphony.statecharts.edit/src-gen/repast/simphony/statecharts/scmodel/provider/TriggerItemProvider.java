...
/**
 * This is the item provider adapter for a {@link repast.simphony.statecharts.scmodel.Trigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StatechartPackage.Literals.TRIGGER__TYPE,
         true,
         false,
         false,
  ...
  public String getText(Object object) {
    TriggerTypes labelValue = ((Trigger)object).getType();
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(Trigger.class)) {
      case StatechartPackage.TRIGGER__TYPE:
