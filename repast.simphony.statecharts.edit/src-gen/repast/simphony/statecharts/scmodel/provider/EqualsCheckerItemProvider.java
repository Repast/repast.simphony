...
/**
 * This is the item provider adapter for a {@link repast.simphony.statecharts.scmodel.EqualsChecker} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EqualsCheckerItemProvider
   ...
   * @generated
   */
  public EqualsCheckerItemProvider(AdapterFactory adapterFactory) {
  ...
  protected void addObjPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_EqualsChecker_obj_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_EqualsChecker_obj_feature", "_UI_EqualsChecker_type"),
         StatechartPackage.Literals.EQUALS_CHECKER__OBJ,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  /**
   * This returns EqualsChecker.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  public Object getImage(Object object) {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/EqualsChecker"));
  }
