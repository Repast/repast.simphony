...
/**
 * This is the item provider adapter for a {@link repast.simphony.systemdynamics.sdmodel.AbstractVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_AbstractVariable_id_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_AbstractVariable_id_feature", "_UI_AbstractVariable_type"),
         SDModelPackage.Literals.ABSTRACT_VARIABLE__ID,
         true,
         false,
         false,
  ...
  protected void addNamePropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_AbstractVariable_name_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_AbstractVariable_name_feature", "_UI_AbstractVariable_type"),
         SDModelPackage.Literals.ABSTRACT_VARIABLE__NAME,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
