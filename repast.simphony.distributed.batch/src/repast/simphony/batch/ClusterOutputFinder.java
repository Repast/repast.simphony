...
public class ClusterOutputFinder {
	 ...
	 * 
	 * @param instanceParentDir parent of instance directories
	 * @param configFile	config.props file
	 * @param scenarioDir	scenario.rs folder
	 * @param outputFile	output file containing all outputs relative to the instanceParentDir
	 * @throws FileNotFoundException
	 * @throws IOException
	 * @throws StatusException
	 * @throws XMLStreamException
	 */
	public void run(String instanceParentDir, String configFile, String scenarioDir, String outputFile) throws FileNotFoundException, IOException, StatusException, XMLStreamException{
		BaseOutputNamesFinder bonFinder = new BaseOutputNamesFinder();
  	List<String> baseNames = bonFinder.find(scenarioDir);
  	
    LocalOutputFinder finder = new LocalOutputFinder();
    for (String base : baseNames){
	    DefaultOutputPatternCreator creator = new DefaultOutputPatternCreator(base);
