 ...
 *
 */
public class AverageUnweightedDistanceTableModel extends DefaultTableModel {

	Graph graph = null;
	Map<Object, Double> resultsMap = new HashMap<Object, Double>();
	List keys = new ArrayList();

	public AverageUnweightedDistanceTableModel(Graph graph) {
		this.graph = graph;
	...
	public String getColumnName(int col) {
		if (col == 0) {
			...
			return "Average Unweighted Distance";
		}
	}
