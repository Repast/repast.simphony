...
public class EditedStyleOGL2D implements StyleOGL2D<Object> {
  ...
  public EditedStyleOGL2D(String styleFile) {
    ...
    if (style == null) style = new DefaultEditedStyleData2D<Object>();
  ...
  public void init(ShapeFactory2D factory) {
    ...
    if (style.getIconFile2D() != null) {
      ...
      float scaleX = origSize / (float)bounds.getWidth();
      float scaleY = origSize / (float)bounds.getWidth();
  ...
  /* (non-Javadoc)
   * @see repast.simphony.visualizationOGL2D.StyleOGL2D#getVSpatial(java.lang.Object, saf.v3d.scene.VSpatial)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see repast.simphony.visualizationOGL2D.StyleOGL2D#getColor(java.lang.Object)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see repast.simphony.visualizationOGL2D.StyleOGL2D#getBorderSize(java.lang.Object)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see repast.simphony.visualizationOGL2D.StyleOGL2D#getBorderColor(java.lang.Object)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see repast.simphony.visualizationOGL2D.StyleOGL2D#getRotation(java.lang.Object)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see repast.simphony.visualizationOGL2D.StyleOGL2D#getScale(java.lang.Object)
   */
  @Override
