 ...
 *
 */
public abstract class AbstractAirspaceLayer extends AirspaceLayer {
...
//			addAirspace(shape.getRenderable());
		}
...
//  }
	...
	protected void addAddedObjects() {
		for (Object o : addedObjects) {
			...
			if (shape !=  null){
//			  airspaceToObjectMap.put(shape.getRenderable(), o);
	...
	protected void removeRemovedObjects() {
		for (Object o : removeObjects) {
			...
			if (shape != null) {
//				this.removeAirspace(shape.getRenderable());
				airspaceToObjectMap.remove(shape.getRenderable());
			}
		}
		removeObjects.clear();
	}
