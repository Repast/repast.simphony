...
public class Material {
  ...
  public void apply(GL gl, int face) {
    ...
    gl2.glMaterialfv(face, GL2.GL_AMBIENT, ambient.getRGBComponents(rgba), 0);
    gl2.glMaterialfv(face, GL2.GL_DIFFUSE, diffuse.getRGBComponents(rgba), 0);
    gl2.glMaterialfv(face, GL2.GL_SPECULAR, specular.getRGBComponents(rgba), 0);
    gl2.glMaterialfv(face, GL2.GL_EMISSION, emission.getRGBComponents(rgba), 0);

    gl2.glMaterialf(face, GL2.GL_SHININESS, shininess);
  }
