...
public class ScheduleStep extends PluginWizardStep {
  ...
  public ScheduleStep() {
    super("Schedule Details",
        "Please enter the update schedule start time, priority, frequency and interval "
            + "for this display");
  ...
  protected JPanel getContentPanel() {
    spPanel = new ScheduleParamsPanel(
        ScheduleParameters.createRepeating(1, 1, ScheduleParameters.LAST_PRIORITY), false);
