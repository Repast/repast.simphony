...
import repast.simphony.visualization.engine.DisplayDescriptor.DisplayType;
  ...
  public EdgeStyleStep() {
    ...
    buildStyleButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        try {
          if (model.getDescriptor().getDisplayType() == DisplayType.TWO_D) {
            ...
            if (dialog.doSave()) {
              ...
              if (model.getDescriptor().getDisplayType()
                  .equals(DisplayDescriptor.DisplayType.TWO_D))
                styleClassName = "repast.simphony.visualization.editedStyle.EditedEdgeStyle2D";
              else if (model.getDescriptor().getDisplayType()
                  .equals(DisplayDescriptor.DisplayType.THREE_D))
