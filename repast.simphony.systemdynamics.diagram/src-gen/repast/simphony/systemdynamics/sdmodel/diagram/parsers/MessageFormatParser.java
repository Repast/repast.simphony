package repast.simphony.systemdynamics.sdmodel.diagram.parsers;
...
public class MessageFormatParser extends AbstractParser {
  ...
  public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
    ...
    if (values == null) {
      return new ParserEditStatus(SystemdynamicsDiagramEditorPlugin.ID,
          IParserEditStatus.UNEDITABLE, NLS.bind(Messages.MessageFormatParser_InvalidInputError,
