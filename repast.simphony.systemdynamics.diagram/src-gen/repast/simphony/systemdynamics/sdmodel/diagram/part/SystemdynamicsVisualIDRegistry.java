...
public class SystemdynamicsVisualIDRegistry {
  ...
  public static int getVisualID(View view) {
    ...
    return repast.simphony.systemdynamics.sdmodel.diagram.part.SystemdynamicsVisualIDRegistry
  ...
  public static int getNodeVisualID(View containerView, EObject domainElement) {
    ...
    String containerModelID = repast.simphony.systemdynamics.sdmodel.diagram.part.SystemdynamicsVisualIDRegistry
    ...
    if (SystemModelEditPart.MODEL_ID.equals(containerModelID)) {
      containerVisualID = repast.simphony.systemdynamics.sdmodel.diagram.part.SystemdynamicsVisualIDRegistry
  ...
  public static int getLinkWithClassVisualID(EObject domainElement) {
    ...
    if (SDModelPackage.eINSTANCE.getCausalLink().isSuperTypeOf(domainElement.eClass())) {
      return CausalLinkEditPart.VISUAL_ID;
    }
    return -1;
  }
