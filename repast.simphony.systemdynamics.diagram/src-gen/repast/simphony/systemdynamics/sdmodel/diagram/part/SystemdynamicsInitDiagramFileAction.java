 ...
 * @generated
 */
public class SystemdynamicsInitDiagramFileAction implements IObjectActionDelegate {
  ...
  public void run(IAction action) {
    ...
    Wizard wizard = new SystemdynamicsNewDiagramFileWizard(domainModelURI, diagramRoot,
        editingDomain);
    wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
        SystemModelEditPart.MODEL_ID));
    SystemdynamicsDiagramEditorUtil.runWizard(getShell(), wizard, "InitDiagramFile"); //$NON-NLS-1$
  }
}
