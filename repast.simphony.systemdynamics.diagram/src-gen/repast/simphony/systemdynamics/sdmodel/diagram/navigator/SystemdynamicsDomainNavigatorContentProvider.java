 ...
 * @generated
 */
public class SystemdynamicsDomainNavigatorContentProvider implements ICommonContentProvider {
   ...
   * @generated
   */
  public SystemdynamicsDomainNavigatorContentProvider() {
  ...
  public Object[] getChildren(Object parentElement) {
    ...
    if (parentElement instanceof SystemdynamicsDomainNavigatorItem) {
      return wrapEObjects(
          myAdapterFctoryContentProvier.getChildren(((SystemdynamicsDomainNavigatorItem) parentElement)
  ...
  public Object[] wrapEObjects(Object[] objects, Object parentElement) {
    ...
    for (int i = 0; i < objects.length; i++) {
      if (objects[i] instanceof EObject) {
        result.add(new SystemdynamicsDomainNavigatorItem((EObject) objects[i], parentElement,
