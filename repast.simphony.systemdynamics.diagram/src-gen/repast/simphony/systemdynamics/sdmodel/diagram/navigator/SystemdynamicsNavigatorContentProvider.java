  ...
  private Object[] getViewChildren(View view, Object parentElement) {
    ...
    case CausalLinkEditPart.VISUAL_ID: {
      ...
      SystemdynamicsNavigatorGroup target = new SystemdynamicsNavigatorGroup(
          Messages.NavigatorGroupName_CausalLink_4002_target,
          "icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
      SystemdynamicsNavigatorGroup source = new SystemdynamicsNavigatorGroup(
          Messages.NavigatorGroupName_CausalLink_4002_source,
    ...
    case StockEditPart.VISUAL_ID: {
      ...
      connectedViews = getIncomingLinksByType(Collections.singleton(sv),
          SystemdynamicsVisualIDRegistry.getType(CausalLinkEditPart.VISUAL_ID));
      incominglinks.addChildren(createNavigatorItems(connectedViews, incominglinks, true));
      connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
          SystemdynamicsVisualIDRegistry.getType(CausalLinkEditPart.VISUAL_ID));
      outgoinglinks.addChildren(createNavigatorItems(connectedViews, outgoinglinks, true));
