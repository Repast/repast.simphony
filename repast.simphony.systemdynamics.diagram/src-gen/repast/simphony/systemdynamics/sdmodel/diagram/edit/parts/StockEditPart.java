...
import repast.simphony.systemdynamics.sdmodel.diagram.edit.policies.StockItemSemanticEditPolicy;
...
public class StockEditPart extends ShapeNodeEditPart {
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.systemdynamics.sdmodel.diagram.edit.parts.StockEditPart) {
      types.add(SystemdynamicsElementTypes.Rate_4003);
    }
    if (targetEditPart instanceof VariableEditPart) {
      types.add(SystemdynamicsElementTypes.CausalLink_4002);
