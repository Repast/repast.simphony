 ...
 * @generated
 */
public class CausalLinkCreateCommand extends EditElementCommand {
   ...
   * @generated
   */
  public CausalLinkCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
  ...
  public boolean canExecute() {
    ...
    return SystemdynamicsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateCausalLink_4002(
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    CausalLink newElement = SDModelFactory.eINSTANCE.createCausalLink();
   ...
   * @generated
   */
  protected void doConfigure(CausalLink newElement, IProgressMonitor monitor, IAdaptable info)
      throws ExecutionException {
