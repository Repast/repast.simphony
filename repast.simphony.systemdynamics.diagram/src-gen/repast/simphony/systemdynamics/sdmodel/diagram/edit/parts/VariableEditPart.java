...
import repast.simphony.systemdynamics.sdmodel.diagram.edit.policies.VariableItemSemanticEditPolicy;
...
public class VariableEditPart extends ShapeNodeEditPart {
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.systemdynamics.sdmodel.diagram.edit.parts.VariableEditPart) {
      types.add(SystemdynamicsElementTypes.Rate_4003);
    }
