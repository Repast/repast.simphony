...
import repast.simphony.systemdynamics.sdmodel.diagram.edit.policies.SystemdynamicsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class StockNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
   ...
   * @generated
   */
  public StockNameEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
        new SystemdynamicsTextSelectionEditPolicy());
    installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new LabelDirectEditPolicy());
    installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new SystemModelEditPart.NodeLabelDragPolicy());
  }
  ...
  protected Image getLabelIcon() {
    ...
    return SystemdynamicsElementTypes.getImage(parserElement.eClass());
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = SystemdynamicsParserProvider
          .getParser(
              SystemdynamicsElementTypes.Stock_2003,
              getParserElement(),
              SystemdynamicsVisualIDRegistry
                  .getType(repast.simphony.systemdynamics.sdmodel.diagram.edit.parts.StockNameEditPart.VISUAL_ID));
    }
    return parser;
  }
  ...
  protected DirectEditManager getManager() {
    if (manager == null) {
      setManager(new TextDirectEditManager2(this, null,
          SystemdynamicsEditPartFactory.getTextCellEditorLocator(this)));
    }
    return manager;
  }
