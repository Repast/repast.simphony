...
import repast.simphony.systemdynamics.sdmodel.diagram.part.SystemdynamicsDiagramUpdater;
import repast.simphony.systemdynamics.sdmodel.diagram.part.SystemdynamicsLinkDescriptor;
import repast.simphony.systemdynamics.sdmodel.diagram.part.SystemdynamicsNodeDescriptor;
...
public class SystemModelCanonicalEditPolicy extends CanonicalEditPolicy {
  ...
  private boolean isMyDiagramElement(View view) {
    ...
    return visualID == VariableEditPart.VISUAL_ID || visualID == CloudEditPart.VISUAL_ID
        || visualID == StockEditPart.VISUAL_ID;
  }
  ...
  private Collection<SystemdynamicsLinkDescriptor> collectAllLinks(View view,
    ...
    case CausalLinkEditPart.VISUAL_ID: {
      if (!domain2NotationMap.containsKey(view.getElement())) {
        result.addAll(SystemdynamicsDiagramUpdater.getCausalLink_4002ContainedLinks(view));
      }
      domain2NotationMap.putView(view.getElement(), view);
      break;
    }
