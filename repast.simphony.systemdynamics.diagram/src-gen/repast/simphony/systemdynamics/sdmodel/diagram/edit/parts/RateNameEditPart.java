 ...
 * @generated
 */
public class RateNameEditPart extends LabelEditPart implements ITextAwareEditPart {
  ...
  static {
    registerSnapBackPosition(
        SystemdynamicsVisualIDRegistry
            .getType(repast.simphony.systemdynamics.sdmodel.diagram.edit.parts.RateNameEditPart.VISUAL_ID),
        new Point(4, 4));
  }
   ...
   * @generated
   */
  public RateNameEditPart(View view) {
    super(view);
  }
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new SystemModelEditPart.LinkLabelDragPolicy());
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = SystemdynamicsParserProvider
          .getParser(
              SystemdynamicsElementTypes.Rate_4003,
              getParserElement(),
              SystemdynamicsVisualIDRegistry
                  .getType(repast.simphony.systemdynamics.sdmodel.diagram.edit.parts.RateNameEditPart.VISUAL_ID));
    }
