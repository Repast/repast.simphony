...
public class SystemdynamicsViewProvider extends AbstractProvider implements IViewProvider {
  ...
  protected boolean provides(CreateNodeViewOperation op) {
    ...
    return VariableEditPart.VISUAL_ID == visualID || CloudEditPart.VISUAL_ID == visualID
        || StockEditPart.VISUAL_ID == visualID;
  }
  ...
  public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint,
    ...
    case CausalLinkEditPart.VISUAL_ID:
      return createCausalLink_4002(getSemanticElement(semanticAdapter), containerView, index,
   ...
   * @generated
   */
  public Edge createCausalLink_4002(EObject domainElement, View containerView, int index,
      boolean persisted, PreferencesHint preferencesHint) {
    ...
    edge.setBendpoints(bendpoints);
    ViewUtil.insertChildView(containerView, edge, index, persisted);
    edge.setType(SystemdynamicsVisualIDRegistry.getType(CausalLinkEditPart.VISUAL_ID));
    edge.setElement(domainElement);
    // initializePreferences
    final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
    FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
