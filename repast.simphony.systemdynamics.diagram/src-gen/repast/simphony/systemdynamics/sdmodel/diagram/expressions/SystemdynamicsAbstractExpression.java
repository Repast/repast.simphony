package repast.simphony.systemdynamics.sdmodel.diagram.expressions;
 ...
 * @generated
 */
public abstract class SystemdynamicsAbstractExpression {
  ...
  protected void setStatus(int severity, String message, Throwable throwable) {
    String pluginID = SystemdynamicsDiagramEditorPlugin.ID;
   ...
   * @generated
   */
  protected SystemdynamicsAbstractExpression(String body, EClassifier context) {
    myBody = body;
    myContext = context;
  }
