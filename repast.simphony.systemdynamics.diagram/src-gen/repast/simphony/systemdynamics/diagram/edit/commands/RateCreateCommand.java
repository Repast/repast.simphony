 ...
 * @generated
 */
public class RateCreateCommand extends EditElementCommand {
   ...
   * @generated
   */
  public RateCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
  ...
  public boolean canExecute() {
    ...
    if (source != null && false == source instanceof Stock) {
      return false;
    }
    if (target != null && false == target instanceof Stock) {
      return false;
    }
    if (getSource() == null) {
    ...
    return SystemdynamicsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateRate_4003(
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    Rate newElement = SDModelFactory.eINSTANCE.createRate();
    getContainer().getVariables().add(newElement);
    newElement.setFrom(getSource());
    newElement.setTo(getTarget());
    ElementInitializers.getInstance().init_Rate_4003(newElement);
   ...
   * @generated
   */
  protected void doConfigure(Rate newElement, IProgressMonitor monitor, IAdaptable info)
      throws ExecutionException {
