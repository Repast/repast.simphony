 ...
 * @generated
 */
public class StockCreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public StockCreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    Stock newElement = SDModelFactory.eINSTANCE.createStock();

    SystemModel owner = (SystemModel) getElementToEdit();
    owner.getVariables().add(newElement);

    ElementInitializers.getInstance().init_Stock_2003(newElement);
   ...
   * @generated
   */
  protected void doConfigure(Stock newElement, IProgressMonitor monitor, IAdaptable info)
      throws ExecutionException {
