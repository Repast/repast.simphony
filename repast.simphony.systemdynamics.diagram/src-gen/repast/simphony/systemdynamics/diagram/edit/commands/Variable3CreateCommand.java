 ...
 * @generated
 */
public class Variable3CreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public Variable3CreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    ElementInitializers.getInstance().init_Variable_2005(newElement);
