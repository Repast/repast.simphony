 ...
 * @generated
 */
public class VariableName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = SystemdynamicsParserProvider
          .getParser(
              SystemdynamicsElementTypes.Variable_2004,
              getParserElement(),
              SystemdynamicsVisualIDRegistry
                  .getType(repast.simphony.systemdynamics.diagram.edit.parts.VariableName2EditPart.VISUAL_ID));
    }
    return parser;
  }
