...
import repast.simphony.systemdynamics.diagram.edit.policies.Variable2ItemSemanticEditPolicy;
...
public class Variable2EditPart extends ShapeNodeEditPart {
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Variable2ItemSemanticEditPolicy());
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.systemdynamics.diagram.edit.parts.Variable2EditPart) {
      types.add(SystemdynamicsElementTypes.InfluenceLink_4004);
    }
