...
import repast.simphony.systemdynamics.diagram.edit.policies.VariableItemSemanticEditPolicy;
...
public class VariableEditPart extends ShapeNodeEditPart {
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.systemdynamics.diagram.edit.parts.VariableEditPart) {
      types.add(SystemdynamicsElementTypes.InfluenceLink_4004);
    }
