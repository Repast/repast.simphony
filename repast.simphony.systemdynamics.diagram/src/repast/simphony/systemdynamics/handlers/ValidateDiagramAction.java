...
//	  msgBox.open();
	  ...
	  GenerateCodeDialog dialog = new GenerateCodeDialog(Display.getCurrent().getActiveShell(), success, "Model Syntax Check:   ", engine.getMessages());
	  dialog.open();
