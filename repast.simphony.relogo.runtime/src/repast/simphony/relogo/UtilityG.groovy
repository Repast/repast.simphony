...
public class UtilityG{
	 ...
	 * @return the chosen directoryÕs absolute path
	 */
	 ...
	 * @return the chosen fileÕs absolute path
	 */
	 ...
	 * @return new fileÕs absolute path
	 */
	...
	/**
	 * Queries for userÕs answer to a question.
	 * @param value question
	 * @return  true or false based on the userÕs answer to value
	 */
