...
public class EmptyParameters implements Parameters {
  ...
  /**
   * Gets the value associated with the specified parameter name. This always
   * returns Parameters.NULL;
   * 
   * @param paramName
  ...
  /* (non-Javadoc)
   * @see repast.simphony.parameter.Parameters#addPropertyChangeListener(java.beans.PropertyChangeListener)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see repast.simphony.parameter.Parameters#removePropertyChangeListener(java.beans.PropertyChangeListener)
   */
  @Override
  ...
  private static class EmptySchema implements Schema {
     ...
     * @return true if the object is of a type valid for the parameter,
     *         otherwise false.
     */
    ...
    /**
     * Returns true if this schema contains contains the specified parameter
     * name, otherwise false.
     * 
     * @param paramName
     * @return true if this schema contains contains the specified parameter
     *         name, otherwise false.
     */
