...
public class StateChartTest {
  ...
  private static class Integrator implements StateChartSimIntegrator {
  ...
  private static class MyAgent1 {
    ...
    public MyAgent1(TestClass tc1, TestClass tc2, TestClass tc3, TestClass tc4) {
      this.tc1 = tc1;
      this.tc2 = tc2;
      this.tc3 = tc3;
      this.tc4 = tc4;
  ...
  private static class MyTransition extends Transition<MyAgent1> {
    ...
    public MyTransition(Trigger trigger, AbstractState<MyAgent1> source,
      ...
      registerOnTransition(new TransitionAction<MyAgent1>() {
        ...
        @Override
        public void action(MyAgent1 agent, Transition<MyAgent1> transition, Parameters params)
            throws Exception {
  ...
  private static class MyStateChart2 extends DefaultStateChart<MyAgent2> {
    ...
    public MyStateChart2(MyAgent2 agent) {
      ...
      SimpleState<MyAgent2> one = new SimpleStateBuilder<MyAgent2>("one").build();
      this.registerEntryState(one);
      SimpleState<MyAgent2> two = new SimpleStateBuilder<MyAgent2>("two").build();
      SimpleState<MyAgent2> three = new SimpleStateBuilder<MyAgent2>("three").build();
      Trigger tr1 = new MessageTrigger<MyAgent2>(getQueue(),
          new MessageEqualsMessageChecker<MyAgent2, String>("a", String.class));
      ...
      Trigger tr2 = new MessageTrigger<MyAgent2>(getQueue(),
          new MessageEqualsMessageChecker<MyAgent2, String>("b", String.class));
      tb.addTrigger(tr2);
  ...
  private static class MyStateChart3 extends DefaultStateChart<MyAgent3> {
    ...
    public MyStateChart3(MyAgent3 agent) {
      super(agent);
      SimpleState<MyAgent3> one = new SimpleStateBuilder<MyAgent3>("one").build();
      this.registerEntryState(one);
      SimpleState<MyAgent3> two = new SimpleStateBuilder<MyAgent3>("two").build();
      SimpleState<MyAgent3> three = new SimpleStateBuilder<MyAgent3>("three").build();
  ...
  /**
   * Random ordering of transitions. Generally ignored, but can be used to check
   * results with specific seed.
   */
  @Ignore
  @Test
  ...
  private static class MyStateChart4 extends DefaultStateChart<MyAgent4> {
    ...
    public MyStateChart4(MyAgent4 agent) {
      super(agent);
      SimpleState<MyAgent4> one = new SimpleStateBuilder<MyAgent4>("one").build();
      this.registerEntryState(one);
      SimpleState<MyAgent4> two = new SimpleStateBuilder<MyAgent4>("two").build();
      SimpleState<MyAgent4> three = new SimpleStateBuilder<MyAgent4>("three").build();
      Trigger tr1 = new TimedTrigger<MyAgent4>(2);
      TransitionBuilder<MyAgent4> tb = new TransitionBuilder<MyAgent4>(one, two);
      tb.addTrigger(tr1);
      tb.setPriority(1);
      Transition<MyAgent4> t1 = tb.build();
      this.addRegularTransition(t1);
      Trigger tr2 = new TimedTrigger<MyAgent4>(3);
  ...
  public void myStateChart4Scenario1() {
    ...
    assertEquals(2, StateChartScheduler.INSTANCE.resolveActions.size());
    assertEquals(true, StateChartScheduler.INSTANCE.resolveActions.containsKey(3d));
    assertEquals(true, StateChartScheduler.INSTANCE.resolveActions.containsKey(4d));
    schedule.execute();
    assertEquals(3, schedule.getTickCount(), 0.0001);
    assertEquals("two", a.st.getCurrentSimpleState().getId());
  }
  ...
  private static class MyStateChart5 extends DefaultStateChart<MyAgent5> {
    ...
    public MyStateChart5(final MyAgent5 a) {
      super(a);
      SimpleState<MyAgent5> one = new SimpleStateBuilder<MyAgent5>("one").build();
      this.registerEntryState(one);
      SimpleState<MyAgent5> two = new SimpleStateBuilder<MyAgent5>("two").build();
      Trigger tr1 = new ConditionTrigger<MyAgent5>(new ConditionTriggerCondition<MyAgent5>() {

        @Override
        public boolean condition(MyAgent5 agent, Transition<MyAgent5> transition, Parameters params)
            throws Exception {
          return a.isTrue;
        }
  ...
  private static class MyStateChart6 extends DefaultStateChart<MyAgent6> {
    public static StateChart<MyAgent6> createStateChart(MyAgent6 agent) {
      SimpleState<MyAgent6> one = new SimpleStateBuilder<MyAgent6>("one").build();
      SimpleState<MyAgent6> two = new SimpleStateBuilder<MyAgent6>("two").build();
      SimpleState<MyAgent6> three = new SimpleStateBuilder<MyAgent6>("three").build();
      SimpleState<MyAgent6> four = new SimpleStateBuilder<MyAgent6>("four").build();

      ConditionTriggerCondition<MyAgent6> state2Condition = new ConditionTriggerCondition<MyAgent6>() {
        @Override
        public boolean condition(MyAgent6 agent, Transition<MyAgent6> transition, Parameters params) {
      ...
      tb.addTrigger(new TimedTrigger<MyAgent6>(1));
      scb.addRegularTransition(tb.build());

      OutOfBranchTransitionBuilder<MyAgent6> oobtb = new OutOfBranchTransitionBuilder<MyAgent6>(bs,
          two);
      ...
      DefaultOutOfBranchTransitionBuilder<MyAgent6> doobtb = new DefaultOutOfBranchTransitionBuilder<MyAgent6>(
          bs, four);
      bt = doobtb.build();
      scb.addRegularTransition(bt);
      return scb.build();
  ...
  private static class MyStateChart6b extends DefaultStateChart<MyAgent6b> {
    public static StateChart<MyAgent6b> createStateChart(MyAgent6b agent) {
      SimpleState<MyAgent6b> one = new SimpleStateBuilder<MyAgent6b>("one").build();
      SimpleState<MyAgent6b> two = new SimpleStateBuilder<MyAgent6b>("two").build();
      SimpleState<MyAgent6b> three = new SimpleStateBuilder<MyAgent6b>("three").build();
      SimpleState<MyAgent6b> four = new SimpleStateBuilder<MyAgent6b>("four").build();

      ConditionTriggerCondition<MyAgent6b> state2Condition = new ConditionTriggerCondition<MyAgent6b>() {
        @Override
        public boolean condition(MyAgent6b agent, Transition<MyAgent6b> transition,
            Parameters params) {
          return agent.value > 0.75;
        }
      };
      ...
      BranchState<MyAgent6b> bs = new BranchStateBuilder<StateChartTest.MyAgent6b>("branch")
          .build();
      CompositeStateBuilder<MyAgent6b> zeroBuilder = new CompositeStateBuilder<MyAgent6b>("zero",
          one);
      zeroBuilder.addChildState(bs);
      zeroBuilder.addChildState(two);
      CompositeState<MyAgent6b> zero = zeroBuilder.build();

      StateChartBuilder<MyAgent6b> scb = new StateChartBuilder<StateChartTest.MyAgent6b>(agent,
          zero);
      scb.addRootState(three);
      scb.addRootState(four);

      TransitionBuilder<MyAgent6b> tb = new TransitionBuilder<StateChartTest.MyAgent6b>(one, bs);
      tb.addTrigger(new TimedTrigger<MyAgent6b>(1));
      scb.addRegularTransition(tb.build());

      OutOfBranchTransitionBuilder<MyAgent6b> oobtb = new OutOfBranchTransitionBuilder<MyAgent6b>(
          bs, two);
      ...
      DefaultOutOfBranchTransitionBuilder<MyAgent6b> doobtb = new DefaultOutOfBranchTransitionBuilder<MyAgent6b>(
          bs, four);
      bt = doobtb.build();
      scb.addRegularTransition(bt);
      return scb.build();
  ...
  private static class MyStateChart7 extends DefaultStateChart<MyAgent7> {
    ...
    public MyStateChart7(final MyAgent7 a) {
      ...
      TransitionAction<MyAgent7> onTransition = new TransitionAction<MyAgent7>() {
        ...
        @Override
        public void action(MyAgent7 agent, Transition<MyAgent7> transition, Parameters params)
            throws Exception {
          agent.value++;
        }
      ...
      Trigger messageTriggerA = new MessageTrigger<MyAgent7>(getQueue(),
          new MessageEqualsMessageChecker<MyAgent7, String>("a", String.class));
      ...
      Trigger messageTriggerB = new MessageTrigger<MyAgent7>(getQueue(),
          new MessageEqualsMessageChecker<MyAgent7, String>("b", String.class));
  ...
  private static class MyStateChart7b extends DefaultStateChart<MyAgent7b> {
    ...
    public MyStateChart7b(final MyAgent7b a) {
      ...
      Trigger messageTriggerA1 = new MessageTrigger<MyAgent7b>(getQueue(),
          new MessageEqualsMessageChecker<MyAgent7b, String>("a", String.class));
      SelfTransitionBuilder<MyAgent7b> stb = new SelfTransitionBuilder<StateChartTest.MyAgent7b>(
          one);
