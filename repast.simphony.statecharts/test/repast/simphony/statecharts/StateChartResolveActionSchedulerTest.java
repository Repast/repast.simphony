...
public class StateChartResolveActionSchedulerTest {
	...
	public void testOneStateChartSameTime() {
		...
		StateChartScheduler.INSTANCE.scheduleResolveTime(1, (DefaultStateChart<?>) sc);
		StateChartScheduler.INSTANCE.scheduleResolveTime(1, (DefaultStateChart<?>) sc);
		StateChartScheduler.INSTANCE.removeResolveTime(1, (DefaultStateChart<?>) sc);
		assertEquals(1,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
		StateChartScheduler.INSTANCE.removeResolveTime(1, (DefaultStateChart<?>) sc);
		assertEquals(0,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
	}
	...
	public void testTwoStateChartsSameTime() {
		...
		StateChartScheduler.INSTANCE.scheduleResolveTime(1, (DefaultStateChart<?>) sc1);
		StateChartScheduler.INSTANCE.scheduleResolveTime(1, (DefaultStateChart<?>) sc2);
		assertEquals(1,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
		StateChartScheduler.INSTANCE.removeResolveTime(1, (DefaultStateChart<?>) sc1);
		assertEquals(1,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
		StateChartScheduler.INSTANCE.removeResolveTime(1, (DefaultStateChart<?>) sc2);
		assertEquals(0,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
	}
	...
	public void testOneStateChartDifferentTime() {
		...
		StateChartScheduler.INSTANCE.scheduleResolveTime(1, (DefaultStateChart<?>) sc);
		assertEquals(1,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
		StateChartScheduler.INSTANCE.scheduleResolveTime(0.5, (DefaultStateChart<?>) sc);
		assertEquals(2,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
		StateChartScheduler.INSTANCE.removeResolveTime(1, (DefaultStateChart<?>) sc);
		assertEquals(1,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
		StateChartScheduler.INSTANCE.removeResolveTime(0.5, (DefaultStateChart<?>) sc);
		assertEquals(0,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
	}
	...
	public void testTwoStateChartsDifferentTime() {
		...
		StateChartScheduler.INSTANCE.scheduleResolveTime(1, (DefaultStateChart<?>) sc1);
		assertEquals(1,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
		StateChartScheduler.INSTANCE.scheduleResolveTime(0.5, (DefaultStateChart<?>) sc2);
		assertEquals(2,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
		StateChartScheduler.INSTANCE.removeResolveTime(1, (DefaultStateChart<?>) sc1);
		assertEquals(1,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
		StateChartScheduler.INSTANCE.removeResolveTime(0.5, (DefaultStateChart<?>) sc2);
		assertEquals(0,RunEnvironment.getInstance().getCurrentSchedule().getModelActionCount());
	}
