...
public class StateChartTest2 {
  ...
  private static class MyStateChart1 extends DefaultStateChart<MyAgent1> {
    ...
    public MyStateChart1(MyAgent1 a) {
      super(a);
      SimpleState<MyAgent1> one = new SimpleStateBuilder<MyAgent1>("one").build();
      CompositeStateBuilder<MyAgent1> csb = new CompositeStateBuilder<StateChartTest2.MyAgent1>(
          "cs", one);

      SimpleState<MyAgent1> two = new SimpleStateBuilder<MyAgent1>("two").build();
  ...
  private static class MyStateChart2 extends DefaultStateChart<MyAgent2> {
    ...
    public MyStateChart2(MyAgent2 a) {
      ...
      TransitionAction<MyAgent2> onTransition = new TransitionAction<StateChartTest2.MyAgent2>() {
        ...
        @Override
        public void action(MyAgent2 agent, Transition<MyAgent2> transition, Parameters params)
            throws Exception {
          agent.value++;
  ...
  private static class MyStateChart3b extends DefaultStateChart<MyAgent3b> {
    ...
    public MyStateChart3b(MyAgent3b a) {
      super(a);
      SimpleState<MyAgent3b> one = new SimpleStateBuilder<MyAgent3b>("one").build();
      CompositeStateBuilder<MyAgent3b> csb = new CompositeStateBuilder<StateChartTest2.MyAgent3b>(
          "cs", one);
      SimpleState<MyAgent3b> two = new SimpleStateBuilder<MyAgent3b>("two").build();
      csb.addChildState(two);
      CompositeState<MyAgent3b> cs = csb.build();
      registerEntryState(cs);

      SimpleState<MyAgent3b> three = new SimpleStateBuilder<MyAgent3b>("three").build();
  ...
  private static class MyStateChart3c extends DefaultStateChart<MyAgent3c> {
    ...
    public MyStateChart3c(MyAgent3c a) {
      super(a);
      SimpleState<MyAgent3c> one = new SimpleStateBuilder<MyAgent3c>("one").build();
      ...
      SimpleState<MyAgent3c> three = new SimpleStateBuilder<MyAgent3c>("three").build();
    ...
    public MyStateChart4(MyAgent4 a) {
      ...
      class MyHistoryStateAction implements StateAction<MyAgent4> {
        ...
        public void action(MyAgent4 agent, AbstractState<MyAgent4> state, Parameters params)
            throws Exception {
          agent.lastHistoryDestination = ((HistoryState<MyAgent4>) state).getDestination().getId();

        }
      }
      HistoryStateBuilder<MyAgent4> hsb3 = new HistoryStateBuilder<StateChartTest2.MyAgent4>("hs3");
      ...
      HistoryStateBuilder<MyAgent4> hsb2 = new HistoryStateBuilder<StateChartTest2.MyAgent4>("hs2");
      hsb2.registerOnEnter(new MyHistoryStateAction());
      HistoryState<MyAgent4> hs2 = hsb2.build();

      SimpleState<MyAgent4> four = new SimpleStateBuilder<MyAgent4>("four").build();
      addState(four);

      SimpleState<MyAgent4> oneA = new SimpleStateBuilder<MyAgent4>("oneA").build();
      SimpleState<MyAgent4> oneB = new SimpleStateBuilder<MyAgent4>("oneB").build();
      addState(four);
  ...
  private static class MyStateChart5 extends DefaultStateChart<MyAgent5> {
    ...
    public static MyStateChart5 createStateChart(MyAgent5 agent) {
      ...
      SimpleState<MyAgent5> four = new SimpleStateBuilder<MyAgent5>("four").build();

      SimpleState<MyAgent5> three = new SimpleStateBuilder<MyAgent5>("three").build();
      ...
      CompositeStateBuilder<MyAgent5> csb1 = new CompositeStateBuilder<MyAgent5>("one", two,
          "twotestuuid");
      csb1.addChildState(fState, "fstatetestuuid");

      CompositeState<MyAgent5> one = csb1.build();

      CompositeStateBuilder<MyAgent5> csb0 = new CompositeStateBuilder<MyAgent5>("zero", one);
      ...
      tb.addTrigger(new MessageTrigger<MyAgent5>(new MessageEqualsMessageChecker<MyAgent5, String>(
          "a", String.class)));
      mb.addRegularTransition(tb.build());
