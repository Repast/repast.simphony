...
public class StyleBuilder {
	...
	/**
	 * Documented setter injection, StyleBuilder uses a StyleFactory for
	 * creation.
	 * 
	 * @param factory
	 */
	...
	public Stroke createStroke(Color color, double width) {
		return sf
				.createStroke(colorExpression(color), literalExpression(width));
	}
	 ...
	 * 
	 * @param color
	 *            an Expression representing the color of the line
	 * @param width
	 *            an Expression representing the width of the line
	 * 
	 * @return the Stroke created
	 */
	 ...
	 *            an Expression representing the width of the line
	 * @param opacity
	 *            an Expression representing opacity the opacity or <I>see
	 *            throughness</I> of the line, 0 - is transparent, 1 is
	 *            completely drawn
	 * 
	 * @return the stroke created
	 */
	 ...
	 * @param opacity
	 *            an expression representing the opacity of the fill 0 -
	...
	public Fill createFill(Color color, Color backgroundColor, double opacity,
		...
		return sf.createFill(colorExpression(color),
				colorExpression(backgroundColor), literalExpression(opacity),
				fill);
	}
	 ...
	 * 
	 * @param color
	 *            an Expression representing the foreground color
	 * @param backgroundColor
	 *            an Expression representing the background color
	 * @param opacity
	 *            an Expression representing the opacity of the fill
	 * @param fill
	 *            the graphic object to use to fill the fill
	 * 
	 * @return the fill created
	...
	public String[] getWellKnownMarkNames() {
		return new String[] { MARK_SQUARE, MARK_CIRCLE, MARK_TRIANGLE,
				MARK_STAR, MARK_CROSS, MARK_ARROW, MARK_X };
	}
	 ...
	 *            an array of external graphics to use if displayable
	 * @param marks
	 *            an array of marks to use
	 * @param symbols
	 *            an array of symbols to use
	 * @param opacity -
	 *            the opacity of the graphic
	 * @param size -
	 *            the size of the graphic
	 ...
	 *            an array of symbols to use
	 * @param opacity -
	 *            an Expression representing the opacity of the graphic
	 * @param size -
	 *            an Expression representing the size of the graphic
	 * @param rotation -
	 *            an Expression representing the rotation from the top of the
	 *            page of the graphic
	 * 
	 * @return the graphic created
	 */
	 ...
	 * @param y -
	 *            an Expression representing the y coordinate of the anchor
	 * 
	 * @return the AnchorPoint created
	 */
	...
	public Displacement createDisplacement(double x, double y) {
		return sf
				.createDisplacement(literalExpression(x), literalExpression(y));
	}
	 ...
	 * 
	 * @param x -
	 *            an Expression representing the x displacement
	 * @param y -
	 ...
	 * @param displacement -
	 *            the displacement of the label
	 * @param rotation -
	 *            an Expresson representing the rotation of the label
	 * 
	 * @return the pointplacement created
	 */
	 ...
	 * 
	 * @param offset -
	 *            an Expression representing the distance between the line and
	 *            the label
	 * 
	 * @return the LinePlacement created
	 */
	...
	public Font createFont(java.awt.Font font) {
		...
		return sf.createFont(family, style, weight, literalExpression(font
				.getSize2D()));
	}
	...
	public Font createFont(String fontFamily, double fontSize) {
		...
		return sf
				.createFont(family, style, weight, literalExpression(fontSize));
	}
	 ...
	 * 
	 * @param fontFamily -
	 *            Expression representing Font family
	 * @param fontStyle -
	 *            Expression representing Font style
	 * @param fontWeight -
	 *            Expression representing Font weight
	 * @param fontSize -
	 *            Expression representing Font size
	 * 
	 * @return the new font object
	 */
	 ...
	 *            the fill of the halo
	 * @param radius -
	 *            an Expression representing the width of the halo
	 * 
	 * @return the new halo
	 */
	 ...
	 * 
	 * @param fill -
	 *            the fill to color the text
	 * @param fonts -
	 *            an array of fonts to use from the first to last
	 * @param halo -
	 *            the halo to be applied to the text
	 * @param label -
	 *            Expression representing the label
	 * @param labelPlacement -
	 *            where to place the label
	 * @param geometryPropertyName -
	 *            the name of the geometry to use
	 * 
	 * @return the new textsymbolizer
	 */
	...
	public FeatureTypeStyle createFeatureTypeStyle(String featureTypeName,
		...
		return createFeatureTypeStyle(featureTypeName, symbolizer, Double.NaN,
				Double.NaN);
	}
	...
	public FeatureTypeStyle createFeatureTypeStyle(String featureTypeName,
		...
		return createFeatureTypeStyle(featureTypeName, symbolizers, Double.NaN,
				Double.NaN);
	}
	...
	public FeatureTypeStyle createFeatureTypeStyle(String featureTypeName,
			...
			double maxScaleDenominator) {
		return createFeatureTypeStyle(featureTypeName,
	 ...
	 *            name of the feature type
	 * @param rules -
	 *            the rules that make up the FeatureTypeStyle
	 * 
	 * @return the new feature type styler
	 */
	public FeatureTypeStyle createFeatureTypeStyle(String featureTypeName,
	 ...
	 *            the name to use for the feature type style
	 * @param symbolizer -
	 *            the symbolizer to use
	 * 
	 * @return the new style
	...
	public Expression attributeExpression(String attributeName)
		...
		org.geotools.filter.AttributeExpression attribute = ff
				.createAttributeExpression(attributeName);
		return attribute;
	}

	/**
	 * given a feature collection and an array of colours build a style with the
	 * given number of classes on the named column
	 * 
	 * @param fc
	 *            DOCUMENT ME!
	 * @param name
	...
	public Style buildClassifiedStyle(FeatureCollection fc, String name,
		...
		for (int i = 1; i < (colors.length - 1); i++) {
			...
			PolygonSymbolizer symb = createPolygonSymbolizer(c, Color.black,
					1.0);
	 ...
	 * 
	 * @param quantities
	 *            The values that begin a category, or break points in a ramp,
	 *            or isolated values, according to the type of color map
	 *            specified by Type
	 * @param colors
	 *            The colors that will be associated to the categories, break
	 *            points, or isolated values
	 * @param type
	 *            Either
	 * @link ColorMap#TYPE_RAMP,
	 * @link ColorMap#TYPE_INTERVALS or
	 * @link ColorMap#TYPE_VALUES
	 */
	public ColorMap createColorMap(String[] labels, double[] quantities,
			Color[] colors, int type) {
		ColorMap colorMap = sf.createColorMap();
		colorMap.setType(type);

		if ((labels == null) || (quantities == null) || (colors == null)
		...
		for (int i = 0; i < colors.length; i++) {
			colorMap.addColorMapEntry(createColorMapEntry(labels[i],
					quantities[i], colors[i]));
		}
	 ...
	 *            The entry's color.
	 */
	private ColorMapEntry createColorMapEntry(String label, double quantity,
			Color color) {
