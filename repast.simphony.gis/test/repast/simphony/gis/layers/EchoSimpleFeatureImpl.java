...
public class EchoSimpleFeatureImpl implements SimpleFeature {
     ...
     * @param id
     */
    public EchoSimpleFeatureImpl( List<Object> values, SimpleFeatureType featureType, FeatureId id) {
     ...
     * @param validating
     */
    public EchoSimpleFeatureImpl(Object[] values, SimpleFeatureType featureType, FeatureId id, boolean validating) {
        this.id = id;
        this.featureType = featureType;
        this.values = values;
        this.validating = validating;
        
        System.out.println("Creating feature " + id.getID());
    ...
    public FeatureId getIdentifier() {
      System.out.println("getIdentifier : " + id.getID());  
    	return id;
    }
    public String getID() {
    ...
    public int getNumberOfAttributes() {
    	System.out.println("getNumberOfAttributes : " + values.length);  
    	return values.length;
    }
    
    public Object getAttribute(int index) throws IndexOutOfBoundsException {
    	System.out.println("getAttribute(int index) : " + index + " : " + values[ index ]);  
    	return values[ index ];
    }
    ...
    public Object getAttribute(String name) {
        ...
        System.out.println("getAttribute(String name) : " + name + " : " + getAttribute(idx));
    ...
    public Object getAttribute(Name name) {
     	System.out.println("getAttribute(Name name) : " + name + " : " + getAttribute( name.getLocalPart() ));
    	
        return getAttribute( name.getLocalPart() );
    }

    public int getAttributeCount() {
    	System.out.println("getAttributeCount() : " + values.length);  
    	
    	return values.length;
    }

    public List<Object> getAttributes() {
    	System.out.println("getAttributes() : " + new ArrayList(Arrays.asList( values )));  
    ...
    public Object getDefaultGeometry() {
       ...
       System.out.println("getDefaultGeometry() : " + defaultGeometry);
       
       return defaultGeometry;
    }

    public SimpleFeatureType getFeatureType() {
    	System.out.println("getFeatureType() : " + featureType);  
    	
    	return featureType;
    }

    public SimpleFeatureType getType() {
    	System.out.println("getType() : " + featureType);    
    ...
    public void setAttribute(String name, Object value) {
  		System.out.println("setAttribute(String name, Object obj) : " + name + " : " + value);  
    ...
    public void setAttribute(Name name, Object value) {
    	System.out.println("setAttribute(Name name, Object obj) : " + name.getLocalPart() + " : " + value);  
    ...
    public void setDefaultGeometry(Object geometry) {
    	System.out.println("ssetDefaultGeometry(Object geometry) : " + geometry);  
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof EchoSimpleFeatureImpl)) {
            return false;
        }

        EchoSimpleFeatureImpl feat = (EchoSimpleFeatureImpl) obj;
