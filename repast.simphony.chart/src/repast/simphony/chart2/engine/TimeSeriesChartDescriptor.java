...
public class TimeSeriesChartDescriptor extends ChartDescriptor {
  ...
  /**
   * @param plotRangeLength
   *          the plotRangeLength to set
   */
  public void setPlotRangeLength(int plotRangeLength) {
    if (this.plotRangeLength != plotRangeLength) {
      this.plotRangeLength = plotRangeLength;
      scs.fireScenarioChanged(this, "plotRangeLength");
    }
  }

  /**
   * Gets the id of the data source used to provide the data for the time
   * series. This is only applicable for time series of non-aggregate data.
   * 
   * @return the id of the data source used to provide the data for the time
   *         series.
   */
   ...
   * series. This is only applicable for time series of non-aggregate data.
   * 
   * param dataValueId the id of the data source used to provide the data for
   * the time series
   */
  public void setDataValueId(String dataValueId) {
    if (this.dataValueId == null || !this.dataValueId.equals(dataValueId)) {
      this.dataValueId = dataValueId;
      scs.fireScenarioChanged(this, "dataValueId");
    }
  }
  ...
  public void addSeriesId(String id, String label, Color color) {
    ...
    scs.fireScenarioChanged(this, "seriesIds");
  }
  ...
  public void addDataValueId(String dataValueId) {
    if (!dataValueIds.contains(dataValueId)) {
      ...
      scs.fireScenarioChanged(this, "dataValueIds");
    }
  }
  ...
  public Iterable<String> dataValueIds() {
    ...
    if (dataValueId != null && !dataValueIds.contains(dataValueId))
      dataValueIds.add(dataValueId);
    return dataValueIds;
  }
   ...
   * @param seriesId
   * 
   * @return the color of the specified series, or null if there is no color.
   */
