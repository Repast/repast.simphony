...
public abstract class ObjectActionLoader<T> extends AbstractActionLoader {
	private static final MessageCenter LOG = MessageCenter
			.getMessageCenter(ObjectActionLoader.class);
	
	protected Class<T> dataClass;
	protected String actionRoot;
	
	public ObjectActionLoader(File file, Object contextID, Class<T> dataClass,
			String actionRoot) {
	...
	protected void performLoad(Reader reader, XStream xstream, Scenario scenario,
		...
		try {
			...
			ControllerAction action = createAction(descriptor);
