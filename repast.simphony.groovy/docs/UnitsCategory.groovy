...
class UnitsCategory {
	...
	static Amount plus(Amount amount1, Amount amount2) {
        return AmountOperations.add(amount1, amount2)
    }

	static Amount multiply(Amount amount1, Amount amount2) {
        return AmountOperations.multiply(amount1, amount2)
    }
	
	static Amount minus(Amount amount1, Amount amount2) {
        return AmountOperations.subtract(amount1, amount2)
    }

	static Amount div(Amount amount1, Amount amount2) {
        return AmountOperations.division(amount1, amount2)
    }
