...
public class XMLTester extends TestCase {
	...
	public void testParse() {
		try {
			ParameterSweepParser parser = new ParameterSweepParser(this.getClass().getResource("params.xml"));
	...
	public void testSimpleStringListSetterCreator() {
		try {
			// <parameter name="list_value" type="list" value_type="String" values="foo bar baz" />
