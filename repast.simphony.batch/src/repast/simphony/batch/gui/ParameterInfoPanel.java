/*
 * Created by JFormDesigner on Wed Aug 05 14:56:35 EDT 2009
 */
...
public class ParameterInfoPanel extends JPanel {
  ...
  private void initComponents() {
    ...
    //---- label1 ----
    label1.setText("Configure dynamic parameter values from this node:");
    add(label1, cc.xy(1, 1));

    //---- label2 ----
    label2.setText("- Press the 'Add Parameter' Button to add a  parameter");
