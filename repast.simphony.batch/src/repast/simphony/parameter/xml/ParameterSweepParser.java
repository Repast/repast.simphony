 ...
 * Additional ParameterSetterCreators can be registered for dealing with additional
 * parameter types using the registerSetterCreator method.
 *
 * @author Nick Collier
...
//		constantCreators.put("number", new ConstantNumberSetterCreator());
	...
	/**
	 * Creates a ParameterSweeper parser to use the specified sweeper
	 * and to parse the specified URL.
	 * 
	 * @param sweeper
	 * @param paramsURL
	 */
	 ...
	 * @param input the input string to write out
	 * @throws IOException
	 */
...
//			paramsURL=new File(paramsURL.getPath()).toURL();
	 ...
	 * When a parameter element whose "type" attribute is equal to the specified
	 * typeID is encountered, the specified creator will be used to create
	 * the ParameterSetter. The attributes of that element will be passed to
	 * the creator so that it can create the setter.
	 *
	 * @param typeID
	 * @param creator
	 */
	 ...
	 * When a parameter element whose "constant type" attribute is equal to the specified
	 * typeID is encountered, the specified creator will be used to create
	 * the ParameterSetter. The attributes of that element will be passed to
	 * the creator so that it can create the constant setter.
	 *
	 * @param constantTypeID matches agains the constant_type attribute.
	 * @param creator
	 */
