 ...
 * @author Jerry Vos
 */
public class DoubleSteppedSetter implements OptimizableParameterSetter {
	...
	protected double getValue() {
		return stepSize.multiply(new BigDecimal(getStep())).add(base).doubleValue();
	}
	...
	public String toString() {
		return "[double " + parameterName + " " + base + "," + max + "," + stepSize + "]";
	}
