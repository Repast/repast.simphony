 ...
 */
public class NewObserverWizardPage extends org.eclipse.jdt.ui.wizards.NewClassWizardPage {
	...
	public NewObserverWizardPage() {
		super();
		setTitle("ReLogo Observer");
		setDescription("Create a new ReLogo Observer");
	...
	public void init(IStructuredSelection selection) {
		...
		setSuperClass("repast.simphony.relogo.BaseObserver", true);
	...
	protected void createTypeMembers(IType type, ImportsManager imports,
		...
		imports.addImport("repast.simphony.relogo.BaseObserver");
