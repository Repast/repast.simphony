 ...
 */
public class NewTurtleWizardPage extends org.eclipse.jdt.ui.wizards.NewClassWizardPage {
	...
	public NewTurtleWizardPage() {
		super();
		setTitle("ReLogo Turtle");
		setDescription("Create a new ReLogo Turtle");
	...
	public void init(IStructuredSelection selection) {
		...
		setSuperClass("repast.simphony.relogo.BaseTurtle", true);
