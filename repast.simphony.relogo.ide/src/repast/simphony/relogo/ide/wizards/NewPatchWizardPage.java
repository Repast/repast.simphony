 ...
 */
public class NewPatchWizardPage extends org.eclipse.jdt.ui.wizards.NewClassWizardPage {
	...
	public NewPatchWizardPage() {
		super();
		setTitle("ReLogo Patch");
		setDescription("Create a new ReLogo Patch");
	...
	public void init(IStructuredSelection selection) {
		...
		setSuperClass("repast.simphony.relogo.BasePatch", true);
	...
	protected void createTypeMembers(IType type, ImportsManager imports,
		...
		imports.addImport("repast.simphony.relogo.ast.Diffusible");
