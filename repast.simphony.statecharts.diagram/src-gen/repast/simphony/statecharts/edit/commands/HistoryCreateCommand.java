 ...
 * @generated
 */
public class HistoryCreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public HistoryCreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    ElementInitializers.getInstance().init_History_3008(newElement);
