 ...
 * @generated
 */
public class History2CreateCommand extends EditElementCommand {

  /**
   * @generated
   */
  public History2CreateCommand(CreateElementRequest req) {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    History newElement = StatechartFactory.eINSTANCE.createHistory();

    CompositeState owner = (CompositeState) getElementToEdit();
    owner.getChildren().add(newElement);

    ElementInitializers.getInstance().init_History_3009(newElement);
   ...
   * @generated
   */
  protected void doConfigure(History newElement, IProgressMonitor monitor, IAdaptable info)
      throws ExecutionException {
