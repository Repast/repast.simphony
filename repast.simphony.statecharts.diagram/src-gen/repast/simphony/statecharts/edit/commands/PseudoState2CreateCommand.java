...
public class PseudoState2CreateCommand extends EditElementCommand {
  ...
  protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
    ...
    PseudoState newElement = StatechartFactory.eINSTANCE.createPseudoState();

    StateMachine owner = (StateMachine) getElementToEdit();
    owner.getStates().add(newElement);

    ElementInitializers.getInstance().init_PseudoState_2006(newElement);
   ...
   * @generated
   */
  protected void doConfigure(PseudoState newElement, IProgressMonitor monitor, IAdaptable info)
      throws ExecutionException {
