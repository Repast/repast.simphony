...
import repast.simphony.statecharts.edit.policies.PseudoStateItemSemanticEditPolicy;
...
public class PseudoStateEditPart extends ShapeNodeEditPart {
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.statecharts.edit.parts.PseudoStateEditPart) {
      types.add(StatechartElementTypes.Transition_4001);
    }
