...
public class FinalState2EditPart extends ShapeNodeEditPart {
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new FinalState2ItemSemanticEditPolicy());
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.statecharts.edit.parts.FinalState2EditPart) {
      types.add(StatechartElementTypes.Transition_4001);
    }
   ...
   * @generated
   */
  public class FinalStateFigure extends repast.simphony.statecharts.figures.FinalStateFigure {
