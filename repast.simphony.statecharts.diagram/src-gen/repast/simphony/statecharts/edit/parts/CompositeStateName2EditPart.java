...
import repast.simphony.statecharts.edit.policies.StatechartTextSelectionEditPolicy;
 ...
 * @generated
 */
public class CompositeStateName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
  ...
  protected void createDefaultEditPolicies() {
    ...
    installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new StateMachineEditPart.NodeLabelDragPolicy());
  }
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = StatechartParserProvider
          .getParser(
              StatechartElementTypes.CompositeState_3002,
              getParserElement(),
              StatechartVisualIDRegistry
                  .getType(repast.simphony.statecharts.edit.parts.CompositeStateName2EditPart.VISUAL_ID));
    }
    return parser;
  }
