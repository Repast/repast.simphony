...
public class StateName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
  ...
  public IParser getParser() {
    if (parser == null) {
      parser = StatechartParserProvider.getParser(StatechartElementTypes.State_3001,
          getParserElement(), StatechartVisualIDRegistry
              .getType(repast.simphony.statecharts.edit.parts.StateName2EditPart.VISUAL_ID));
    }
    return parser;
  }
