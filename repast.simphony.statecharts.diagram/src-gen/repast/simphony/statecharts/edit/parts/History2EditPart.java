 ...
 * @generated
 */
public class History2EditPart extends ShapeNodeEditPart {
   ...
   * @generated
   */
  public History2EditPart(View view) {
    super(view);
  }
  ...
  protected IFigure createNodeShape() {
    return primaryShape = getPrimaryShape();
  }
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.statecharts.edit.parts.History2EditPart) {
      types.add(StatechartElementTypes.Transition_4001);
    }
    return types;
  }
