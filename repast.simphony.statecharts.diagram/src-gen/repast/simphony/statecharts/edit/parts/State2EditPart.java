...
import repast.simphony.statecharts.edit.policies.State2ItemSemanticEditPolicy;
...
public class State2EditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof StateName2EditPart) {
      ((StateName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureStateNameFigure());
      return true;
    }
    return false;
  }
  ...
  public EditPart getPrimaryChildEditPart() {
    return getChildBySemanticHint(StatechartVisualIDRegistry.getType(StateName2EditPart.VISUAL_ID));
  }
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.statecharts.edit.parts.State2EditPart) {
      types.add(StatechartElementTypes.Transition_4001);
    }
