...
public class PseudoState5EditPart extends ShapeNodeEditPart {
  ...
  protected IFigure createNodeShape() {
    return primaryShape = new FirstStateFigure();
  }

  /**
   * @generated
   */
  public FirstStateFigure getPrimaryShape() {
    return (FirstStateFigure) primaryShape;
  }
  ...
  protected NodeFigure createNodePlate() {
    return new DefaultSizeNodeFigureFixedAnchors(17, 17, AnchorLocationFactory.createCenter());
  }
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.statecharts.edit.parts.PseudoState5EditPart) {
      types.add(StatechartElementTypes.Transition_4001);
    }
