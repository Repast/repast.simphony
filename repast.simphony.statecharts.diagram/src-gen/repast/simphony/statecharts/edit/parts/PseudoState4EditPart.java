...
import repast.simphony.statecharts.edit.policies.PseudoState4ItemSemanticEditPolicy;
...
public class PseudoState4EditPart extends ShapeNodeEditPart {
  ...
  protected NodeFigure createNodePlate() {
    return new DefaultSizeNodeFigureFixedAnchors(19, 19, AnchorLocationFactory.createNSEW());
  }
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.statecharts.edit.parts.PseudoState4EditPart) {
      types.add(StatechartElementTypes.Transition_4001);
    }
   ...
   * @generated
   */
  public class ChoiceFigure extends repast.simphony.statecharts.figures.ChoiceFigure {

    /**
     * @generated
     */
    public ChoiceFigure() {
      this.setPreferredSize(new Dimension(getMapMode().DPtoLP(19), getMapMode().DPtoLP(19)));
      this.setMaximumSize(new Dimension(getMapMode().DPtoLP(19), getMapMode().DPtoLP(19)));
      this.setMinimumSize(new Dimension(getMapMode().DPtoLP(19), getMapMode().DPtoLP(19)));
    }
