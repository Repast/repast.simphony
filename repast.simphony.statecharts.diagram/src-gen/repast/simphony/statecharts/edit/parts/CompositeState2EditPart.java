...
public class CompositeState2EditPart extends ShapeNodeEditPart {
  ...
  protected boolean addFixedChild(EditPart childEditPart) {
    if (childEditPart instanceof CompositeStateName2EditPart) {
      ((CompositeStateName2EditPart) childEditPart).setLabel(getPrimaryShape()
          .getFigureCompositeStateNameFigure());
      return true;
    }
    if (childEditPart instanceof CompositeStateCompositeStateCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigureCompositeStateCompartmentRectangle();
      setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
      pane.add(((CompositeStateCompositeStateCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  protected boolean removeFixedChild(EditPart childEditPart) {
    ...
    if (childEditPart instanceof CompositeStateCompositeStateCompartment2EditPart) {
      IFigure pane = getPrimaryShape().getFigureCompositeStateCompartmentRectangle();
      pane.remove(((CompositeStateCompositeStateCompartment2EditPart) childEditPart).getFigure());
      return true;
    }
    return false;
  }
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.statecharts.edit.parts.CompositeState2EditPart) {
      types.add(StatechartElementTypes.Transition_4001);
    }
