...
import repast.simphony.statecharts.edit.policies.FinalStateItemSemanticEditPolicy;
...
public class FinalStateEditPart extends ShapeNodeEditPart {
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.statecharts.edit.parts.FinalStateEditPart) {
      types.add(StatechartElementTypes.Transition_4001);
    }
