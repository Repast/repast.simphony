...
import repast.simphony.statecharts.edit.policies.PseudoState3ItemSemanticEditPolicy;
...
public class PseudoState3EditPart extends ShapeNodeEditPart {
  ...
  public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
    ...
    if (targetEditPart instanceof repast.simphony.statecharts.edit.parts.PseudoState3EditPart) {
      types.add(StatechartElementTypes.Transition_4001);
    }
   ...
   * @generated
   */
  public class InitialStateFigure extends repast.simphony.statecharts.figures.InitialStateFigure {
