 ...
 * @generated
 */
public class StatechartValidationDecoratorProvider extends AbstractProvider implements
    IDecoratorProvider {
   ...
   * @generated
   */
  private static final String MARKER_TYPE = StatechartDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
  ...
  public boolean provides(IOperation operation) {
    ...
    return view != null
        && StateMachineEditPart.MODEL_ID.equals(StatechartVisualIDRegistry.getModelID(view));
  }
    ...
    PlatformUI.getWorkbench().getDisplay().asyncExec(new Runnable() {
      ...
      public void run() {
        try {
          ...
          StatechartDiagramEditorPlugin.getInstance().logError("Decorator refresh failure", e); //$NON-NLS-1$
        }
      }
    });
  }
  ...
  public static class StatusDecorator extends AbstractDecorator {
    ...
    public StatusDecorator(IDecoratorTarget decoratorTarget) {
      ...
      try {
        ...
        StatechartDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
      }
    }
