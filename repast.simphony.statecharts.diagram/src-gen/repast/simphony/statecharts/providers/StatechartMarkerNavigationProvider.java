...
import repast.simphony.statecharts.part.StatechartDiagramEditorUtil;
...
public class StatechartMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {
  ...
  public static IMarker addMarker(IFile file, String elementId, String location, String message,
    ...
    try {
      ...
      marker
          .setAttribute(org.eclipse.gmf.runtime.common.ui.resources.IMarker.ELEMENT_ID, elementId);
