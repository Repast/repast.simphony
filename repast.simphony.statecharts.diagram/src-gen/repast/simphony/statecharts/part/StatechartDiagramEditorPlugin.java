...
import repast.simphony.statecharts.scmodel.provider.StatechartItemProviderAdapterFactory;
...
public class StatechartDiagramEditorPlugin extends AbstractUIPlugin {
   ...
   * @generated
   */
  public static final String ID = "repast.simphony.statecharts.diagram"; //$NON-NLS-1$
  ...
  public void logError(String error, Throwable throwable) {
    ...
    getLog().log(
        new Status(IStatus.ERROR, StatechartDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
  ...
  public void logInfo(String message, Throwable throwable) {
    ...
    getLog().log(
        new Status(IStatus.INFO, StatechartDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
