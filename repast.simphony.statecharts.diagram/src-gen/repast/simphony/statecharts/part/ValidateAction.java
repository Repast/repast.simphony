...
import repast.simphony.statecharts.providers.StatechartMarkerNavigationProvider;
import repast.simphony.statecharts.providers.StatechartValidationProvider;
...
public class ValidateAction extends Action {
  ...
  private static void validate(DiagramEditPart diagramEditPart, View view) {
    ...
    validator.setTraversalStrategy(StatechartValidationProvider
  ...
  private static void createMarkers(IFile target, IStatus validationStatus,
    ...
    for (Iterator it = allStatuses.iterator(); it.hasNext();) {
      ...
      View view = StatechartDiagramEditorUtil.findView(diagramEditPart, nextStatus.getTarget(),
          element2ViewMap);
  ...
  private static void addMarker(EditPartViewer viewer, IFile target, String elementId,
    ...
    StatechartMarkerNavigationProvider.addMarker(target, elementId, location, message,
        statusSeverity);
  }
